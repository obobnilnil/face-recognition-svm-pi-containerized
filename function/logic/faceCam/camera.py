...
class CameraApp:
    def __init__(self, detector, cam_index=0, save_interval=2, mode="recognize"):
        ...
        model_path = Path("/home/jaidog/camera_pi/MLproject/face_recognition_model.joblib")
    ...
    def upload_and_send_metadata(self, face_img, encoding=None, name="default value", camera_id="cam_01"): ## default value
        ...
        try:
            ...
            res = requests.post("http://192.168.1.233:8889/api/UploadImageAndReturnPath", files=files, data=data)
            ...
            # Send metadata
            meta_res = requests.post("http://192.168.1.233:8889/api/InputFaceRecognitionDetails", json=metadata)
    ...
    def run(self):
        try:
            ...
            # out = cv2.VideoWriter('output_recorded.mp4', fourcc, 15.0, (640, 480))
